package com.skilldistillery.recipetracker.security;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        .antMatchers(HttpMethod.GET, "/api/recipes").permitAll()     // will hit the OPTIONS on the route
        .antMatchers(HttpMethod.GET, "/api/recipes/{recipeId}").permitAll()     // will hit the OPTIONS on the route

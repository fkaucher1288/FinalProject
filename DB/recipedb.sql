...
START TRANSACTION;
USE `recipe`;
INSERT INTO `user` (`id`, `username`, `email`, `password`, `first_name`, `last_name`, `enabled`, `role`, `date_created`, `date_updated`, `image_url`) VALUES (1, 'wolfgangPuck', 'wolfgangPuck@gmail.com', '$2a$10$Ofg7vwo1bEe09oxtQDA2geVpiibBWkcPZZpoRBuSOI0fId.MRzOBa', 'Wolfgang', 'Puck', 1, 'admin', '2022-01-01 00:00:00', '2022-01-01 00:00:00', 'https://upload.wikimedia.org/wikipedia/commons/thumb/1/16/Wolfgang_Puck_2012.jpg/440px-Wolfgang_Puck_2012.jpg');
...
INSERT INTO `recipe` (`id`, `name`, `date_created`, `active`, `creator_id`, `is_public`, `prep_time`, `cook_time`, `description`, `instructions`, `notes`, `photo_link`, `web_link`) VALUES (12, 'The Best (and Easiest) Ice Cream You\'ll Ever Make', '2022-01-01 00:00:00', 1, 1, 1, '5m', '5m', 'Rich and creamy homemade vanilla ice cream recipe that only requires five ingredients!', 'Pour 1 cup of the cream into a saucepan and add the sugar, salt. Scrape the seeds of the vanilla bean into the pot and then add the vanilla pod to the pot. Warm the mixture over medium heat, just until the sugar dissolves. Remove from the heat and add the remaining cream, milk, and vanilla extract (if using extract). Stir to combine and chill in the refrigerator. When ready to churn, remove the vanilla pod, whisk mixture again and pour into ice cream maker. Churn according to the manufacturer\'s instructions. Transfer the finished ice cream to an airtight container and place in the freezer until ready to serve. Enjoy!', 'Feel free to skip the simmer step and simply whisk everything together, then pour directly into the ice cream maker. The ice cream is absolutely delicious this way, as well as when simmered and chilled first.', 'https://barefeetinthekitchen.com/wp-content/uploads/2018/05/Easiest-Ice-Cream-1-1-of-1-600x600.jpg', '');
INSERT INTO `recipe` (`id`, `name`, `date_created`, `active`, `creator_id`, `is_public`, `prep_time`, `cook_time`, `description`, `instructions`, `notes`, `photo_link`, `web_link`) VALUES (13, 'Orange Sorbet', '2022-01-01 00:00:00', 1, 2, 1, '15m', '20m', 'Whether you serve it in chilled bowls or scoop it into cut lemon halves, this creamy four-ingredient sorbet is both sweet and tart. It makes a delightfully refreshing finish to any meal.', '1. Place sugar and water in a small saucepan; bring to a boil over medium heat, stirring constantly. Reduce heat; simmer, uncovered, 2 minutes. Cool completely.\n2. Stir in lemon zest and juice. Fill cylinder of ice cream maker no more than two-thirds full; freeze according to manufacturer\'s directions.\n3. Transfer sorbet to a freezer container, allowing headspace for expansion. Freeze until firm, about 4 hours. If desired, serve in cookie cups with lemon wedges and top with additional lemon zest.', '', 'https://www.tasteofhome.com/wp-content/uploads/2018/01/Lemon-Sorbet_EXPS_QEBZ20_25719_E01_28_2b-1.jpg?w=1200', '');
...
INSERT INTO `recipe_ingredient` (`ingredient_id`, `recipe_id`, `quantity`, `remarks`) VALUES (3, 7, 6, 'Minced');
...
INSERT INTO `recipe_ingredient` (`ingredient_id`, `recipe_id`, `quantity`, `remarks`) VALUES (80, 12, 2, '');
...
INSERT INTO `recipe_ingredient` (`ingredient_id`, `recipe_id`, `quantity`, `remarks`) VALUES (2, 3, 1, '');
...
INSERT INTO `recipe_ingredient` (`ingredient_id`, `recipe_id`, `quantity`, `remarks`) VALUES (3, 4, 2, 'Minced');
INSERT INTO `recipe_ingredient` (`ingredient_id`, `recipe_id`, `quantity`, `remarks`) VALUES (70, 4, 6, '');
INSERT INTO `recipe_ingredient` (`ingredient_id`, `recipe_id`, `quantity`, `remarks`) VALUES (12, 5, 1, '');
INSERT INTO `recipe_ingredient` (`ingredient_id`, `recipe_id`, `quantity`, `remarks`) VALUES (13, 5, 1, '');
INSERT INTO `recipe_ingredient` (`ingredient_id`, `recipe_id`, `quantity`, `remarks`) VALUES (14, 5, 1, '');
...
INSERT INTO `recipe_ingredient` (`ingredient_id`, `recipe_id`, `quantity`, `remarks`) VALUES (1, 1, 4, '');
INSERT INTO `recipe_ingredient` (`ingredient_id`, `recipe_id`, `quantity`, `remarks`) VALUES (71, 1, 24, 'Minced');
INSERT INTO `recipe_ingredient` (`ingredient_id`, `recipe_id`, `quantity`, `remarks`) VALUES (72, 1, 10, 'Minced');
INSERT INTO `recipe_ingredient` (`ingredient_id`, `recipe_id`, `quantity`, `remarks`) VALUES (73, 1, 24, '');
INSERT INTO `recipe_ingredient` (`ingredient_id`, `recipe_id`, `quantity`, `remarks`) VALUES (20, 1, 14, '');
INSERT INTO `recipe_ingredient` (`ingredient_id`, `recipe_id`, `quantity`, `remarks`) VALUES (39, 1, 3, '');
INSERT INTO `recipe_ingredient` (`ingredient_id`, `recipe_id`, `quantity`, `remarks`) VALUES (74, 1, 2, 'Cubes');
INSERT INTO `recipe_ingredient` (`ingredient_id`, `recipe_id`, `quantity`, `remarks`) VALUES (75, 1, 1, '');
INSERT INTO `recipe_ingredient` (`ingredient_id`, `recipe_id`, `quantity`, `remarks`) VALUES (76, 1, 1, '');
INSERT INTO `recipe_ingredient` (`ingredient_id`, `recipe_id`, `quantity`, `remarks`) VALUES (67, 1, 1, '');
INSERT INTO `recipe_ingredient` (`ingredient_id`, `recipe_id`, `quantity`, `remarks`) VALUES (27, 1, 1, '');
INSERT INTO `recipe_ingredient` (`ingredient_id`, `recipe_id`, `quantity`, `remarks`) VALUES (19, 1, 1, '');
INSERT INTO `recipe_ingredient` (`ingredient_id`, `recipe_id`, `quantity`, `remarks`) VALUES (2, 1, 4, '');
INSERT INTO `recipe_ingredient` (`ingredient_id`, `recipe_id`, `quantity`, `remarks`) VALUES (77, 1, 1, '');
INSERT INTO `recipe_ingredient` (`ingredient_id`, `recipe_id`, `quantity`, `remarks`) VALUES (80, 1, 4, '');
INSERT INTO `recipe_ingredient` (`ingredient_id`, `recipe_id`, `quantity`, `remarks`) VALUES (45, 1, 1, 'Grated');
INSERT INTO `recipe_ingredient` (`ingredient_id`, `recipe_id`, `quantity`, `remarks`) VALUES (78, 1, 13, '');
INSERT INTO `recipe_ingredient` (`ingredient_id`, `recipe_id`, `quantity`, `remarks`) VALUES (79, 1, 17, 'Shredded');
INSERT INTO `recipe_ingredient` (`ingredient_id`, `recipe_id`, `quantity`, `remarks`) VALUES (5, 1, 2, 'Chopped');
...
START TRANSACTION;
USE `recipe`;
INSERT INTO `category` (`id`, `name`, `description`, `category_type_id`) VALUES (1, 'Italian', '', 1);
...
INSERT INTO `category` (`id`, `name`, `description`, `category_type_id`) VALUES (56, 'Sweet', '', 2);
INSERT INTO `category` (`id`, `name`, `description`, `category_type_id`) VALUES (57, 'Spicy', '', 2);
INSERT INTO `category` (`id`, `name`, `description`, `category_type_id`) VALUES (58, 'Savory', '', 2);
INSERT INTO `category` (`id`, `name`, `description`, `category_type_id`) VALUES (59, 'Sour', '', 2);
INSERT INTO `category` (`id`, `name`, `description`, `category_type_id`) VALUES (60, 'Bitter', '', 2);
INSERT INTO `category` (`id`, `name`, `description`, `category_type_id`) VALUES (83, 'Umami', '', 2);
INSERT INTO `category` (`id`, `name`, `description`, `category_type_id`) VALUES (61, 'Salty', '', 2);
INSERT INTO `category` (`id`, `name`, `description`, `category_type_id`) VALUES (62, 'Dairy', '', 3);
INSERT INTO `category` (`id`, `name`, `description`, `category_type_id`) VALUES (63, 'Eggs', '', 3);
INSERT INTO `category` (`id`, `name`, `description`, `category_type_id`) VALUES (64, 'Peanuts', '', 3);
INSERT INTO `category` (`id`, `name`, `description`, `category_type_id`) VALUES (65, 'Nuts', '', 3);
INSERT INTO `category` (`id`, `name`, `description`, `category_type_id`) VALUES (66, 'Soy', '', 3);
INSERT INTO `category` (`id`, `name`, `description`, `category_type_id`) VALUES (67, 'Wheat', '', 3);
INSERT INTO `category` (`id`, `name`, `description`, `category_type_id`) VALUES (68, 'Tree Nuts', '', 3);
INSERT INTO `category` (`id`, `name`, `description`, `category_type_id`) VALUES (69, 'Fish', '', 3);
INSERT INTO `category` (`id`, `name`, `description`, `category_type_id`) VALUES (70, 'Shellfish', '', 3);
INSERT INTO `category` (`id`, `name`, `description`, `category_type_id`) VALUES (71, 'Sesame', '', 3);
INSERT INTO `category` (`id`, `name`, `description`, `category_type_id`) VALUES (72, 'Sulphites', '', 3);
INSERT INTO `category` (`id`, `name`, `description`, `category_type_id`) VALUES (73, 'Celery', '', 3);
INSERT INTO `category` (`id`, `name`, `description`, `category_type_id`) VALUES (74, 'Gluten Free', '', 4);
INSERT INTO `category` (`id`, `name`, `description`, `category_type_id`) VALUES (75, 'Vegan', '', 4);
INSERT INTO `category` (`id`, `name`, `description`, `category_type_id`) VALUES (76, 'Paleo', '', 4);
INSERT INTO `category` (`id`, `name`, `description`, `category_type_id`) VALUES (77, 'Weight Watchers', '', 4);
INSERT INTO `category` (`id`, `name`, `description`, `category_type_id`) VALUES (78, 'South Beach', '', 4);
INSERT INTO `category` (`id`, `name`, `description`, `category_type_id`) VALUES (79, 'Raw', '', 4);
INSERT INTO `category` (`id`, `name`, `description`, `category_type_id`) VALUES (80, 'Atkins', '', 4);
INSERT INTO `category` (`id`, `name`, `description`, `category_type_id`) VALUES (81, 'Zone', '', 4);
INSERT INTO `category` (`id`, `name`, `description`, `category_type_id`) VALUES (82, 'Mediterranean', '', 4);
...
INSERT INTO `recipe_has_category` (`recipe_id`, `category_id`) VALUES (7, 62);
INSERT INTO `recipe_has_category` (`recipe_id`, `category_id`) VALUES (9, 62);
INSERT INTO `recipe_has_category` (`recipe_id`, `category_id`) VALUES (10, 62);
INSERT INTO `recipe_has_category` (`recipe_id`, `category_id`) VALUES (11, 62);
INSERT INTO `recipe_has_category` (`recipe_id`, `category_id`) VALUES (13, 63);
INSERT INTO `recipe_has_category` (`recipe_id`, `category_id`) VALUES (12, 63);
INSERT INTO `recipe_has_category` (`recipe_id`, `category_id`) VALUES (11, 63);
INSERT INTO `recipe_has_category` (`recipe_id`, `category_id`) VALUES (2, 63);
INSERT INTO `recipe_has_category` (`recipe_id`, `category_id`) VALUES (4, 63);
INSERT INTO `recipe_has_category` (`recipe_id`, `category_id`) VALUES (1, 64);
INSERT INTO `recipe_has_category` (`recipe_id`, `category_id`) VALUES (9, 64);
INSERT INTO `recipe_has_category` (`recipe_id`, `category_id`) VALUES (10, 64);
INSERT INTO `recipe_has_category` (`recipe_id`, `category_id`) VALUES (8, 65);
INSERT INTO `recipe_has_category` (`recipe_id`, `category_id`) VALUES (1, 65);
INSERT INTO `recipe_has_category` (`recipe_id`, `category_id`) VALUES (6, 65);
INSERT INTO `recipe_has_category` (`recipe_id`, `category_id`) VALUES (4, 66);
INSERT INTO `recipe_has_category` (`recipe_id`, `category_id`) VALUES (5, 66);
INSERT INTO `recipe_has_category` (`recipe_id`, `category_id`) VALUES (6, 66);
INSERT INTO `recipe_has_category` (`recipe_id`, `category_id`) VALUES (4, 67);
INSERT INTO `recipe_has_category` (`recipe_id`, `category_id`) VALUES (1, 67);
INSERT INTO `recipe_has_category` (`recipe_id`, `category_id`) VALUES (1, 68);
INSERT INTO `recipe_has_category` (`recipe_id`, `category_id`) VALUES (7, 68);
INSERT INTO `recipe_has_category` (`recipe_id`, `category_id`) VALUES (8, 69);
INSERT INTO `recipe_has_category` (`recipe_id`, `category_id`) VALUES (9, 69);
INSERT INTO `recipe_has_category` (`recipe_id`, `category_id`) VALUES (4, 70);
INSERT INTO `recipe_has_category` (`recipe_id`, `category_id`) VALUES (5, 70);
INSERT INTO `recipe_has_category` (`recipe_id`, `category_id`) VALUES (12, 71);
INSERT INTO `recipe_has_category` (`recipe_id`, `category_id`) VALUES (1, 71);
INSERT INTO `recipe_has_category` (`recipe_id`, `category_id`) VALUES (7, 72);
INSERT INTO `recipe_has_category` (`recipe_id`, `category_id`) VALUES (8, 72);
INSERT INTO `recipe_has_category` (`recipe_id`, `category_id`) VALUES (1, 73);
INSERT INTO `recipe_has_category` (`recipe_id`, `category_id`) VALUES (6, 73);
INSERT INTO `recipe_has_category` (`recipe_id`, `category_id`) VALUES (7, 74);
INSERT INTO `recipe_has_category` (`recipe_id`, `category_id`) VALUES (5, 74);
INSERT INTO `recipe_has_category` (`recipe_id`, `category_id`) VALUES (11, 75);
INSERT INTO `recipe_has_category` (`recipe_id`, `category_id`) VALUES (7, 75);
INSERT INTO `recipe_has_category` (`recipe_id`, `category_id`) VALUES (7, 76);
INSERT INTO `recipe_has_category` (`recipe_id`, `category_id`) VALUES (8, 76);
INSERT INTO `recipe_has_category` (`recipe_id`, `category_id`) VALUES (5, 77);
...
INSERT INTO `recipe_has_category` (`recipe_id`, `category_id`) VALUES (13, 77);
INSERT INTO `recipe_has_category` (`recipe_id`, `category_id`) VALUES (1, 78);
INSERT INTO `recipe_has_category` (`recipe_id`, `category_id`) VALUES (9, 79);
INSERT INTO `recipe_has_category` (`recipe_id`, `category_id`) VALUES (7, 80);
INSERT INTO `recipe_has_category` (`recipe_id`, `category_id`) VALUES (1, 81);
INSERT INTO `recipe_has_category` (`recipe_id`, `category_id`) VALUES (6, 82);

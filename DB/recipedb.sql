...
INSERT INTO `ingredient` (`id`, `name`, `measurement_unit`, `brand`, `category`) VALUES (3, 'Shredded cheese', 'Cup', '', 'dairy');
INSERT INTO `ingredient` (`id`, `name`, `measurement_unit`, `brand`, `category`) VALUES (4, 'Parsley', 'Bunch', '', 'Vegetables');
INSERT INTO `ingredient` (`id`, `name`, `measurement_unit`, `brand`, `category`) VALUES (5, 'Bread', 'Slice', '', 'Grain');
INSERT INTO `ingredient` (`id`, `name`, `measurement_unit`, `brand`, `category`) VALUES (6, 'Apples', 'Ounce', '', 'Fruit');
INSERT INTO `ingredient` (`id`, `name`, `measurement_unit`, `brand`, `category`) VALUES (7, 'Chicken', 'Ounce', '', 'Meat');
INSERT INTO `ingredient` (`id`, `name`, `measurement_unit`, `brand`, `category`) VALUES (8, 'honey', 'Tablespoon', '', 'Sugar');
INSERT INTO `ingredient` (`id`, `name`, `measurement_unit`, `brand`, `category`) VALUES (9, 'Bacon', 'Ounce', '', 'Meat');
INSERT INTO `ingredient` (`id`, `name`, `measurement_unit`, `brand`, `category`) VALUES (10, 'Egg', 'Unit', '', 'Dairy');
INSERT INTO `ingredient` (`id`, `name`, `measurement_unit`, `brand`, `category`) VALUES (11, 'Lemon Juice', 'Cup', '', 'Fruit');
INSERT INTO `ingredient` (`id`, `name`, `measurement_unit`, `brand`, `category`) VALUES (12, 'Suger', 'Tablespoon', '', 'Sweets');
INSERT INTO `ingredient` (`id`, `name`, `measurement_unit`, `brand`, `category`) VALUES (13, 'Water', 'Cup', '', 'Liquid');
INSERT INTO `ingredient` (`id`, `name`, `measurement_unit`, `brand`, `category`) VALUES (14, 'Lemon juice', 'Cup', '', 'Liquid');
INSERT INTO `ingredient` (`id`, `name`, `measurement_unit`, `brand`, `category`) VALUES (15, 'Yogurt', 'Cup', '', 'Dairy');
INSERT INTO `ingredient` (`id`, `name`, `measurement_unit`, `brand`, `category`) VALUES (16, 'Olive oil', 'Tablespoon', '', 'Oils');
INSERT INTO `ingredient` (`id`, `name`, `measurement_unit`, `brand`, `category`) VALUES (17, 'Red pepper flakes', 'Teaspoon', '', 'Seasoning');
INSERT INTO `ingredient` (`id`, `name`, `measurement_unit`, `brand`, `category`) VALUES (18, 'Salt', 'Teaspoon', '', 'Seasoning');
INSERT INTO `ingredient` (`id`, `name`, `measurement_unit`, `brand`, `category`) VALUES (19, 'Crushed Tomatos', 'Ounce', '', 'Vegetables');
INSERT INTO `ingredient` (`id`, `name`, `measurement_unit`, `brand`, `category`) VALUES (20, 'Spaghetti sauce', 'Ounce', '', '');
INSERT INTO `ingredient` (`id`, `name`, `measurement_unit`, `brand`, `category`) VALUES (21, 'Noodles', 'Ounce', '', 'Pasta');
